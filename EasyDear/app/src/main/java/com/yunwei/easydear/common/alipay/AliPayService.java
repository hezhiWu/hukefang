package com.yunwei.easydear.common.alipay;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SDK_PAY_FLAG:
                    ...
                    ILog.v(TAG, "----------> resultInfo = " + resultInfo);
                    ILog.v(TAG, "----------> resultStatus = " + resultStatus);
...
//        }
        ...
        ILog.v(TAG, "----------> orderInfo = " + orderInfo);
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                ...
                // 调用支付接口，获取支付结果
                ILog.v(TAG, "----------> payInfo = " + payInfo);
                String result = alipay.pay(payInfo, true);
                ILog.v(TAG, "----------> result = " + result);
